    ...
    >
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-xl">
        ...
        <form className="px-6 py-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" className="w-full rounded-lg bg-orange-500 px-4 py-3 text-sm font-semibold text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-300">
            Entrar
          </button>
        </form>
